...
year_report <- 2021 # year of survey
...
#TODO here package look up 
#TODO make sure the facet and breakdown is in the report at the begining
#TODO link to dashboard in rmd
...
# survey data
 ...
 data <- data %>% filter(question != "lsoa_code")
...
-  Out of responses from `r group_name`, **`r filter(stats,  breakdown == group_breakdown & question == 'pa_60' & response == "6-7") %>% .$value`** had done a total of 60 minutes or more of physical activity 6-7 days of the week  (in line with recommended daily physical activity guidance). `r ls1` The most common response when asked how many days `r group_name` have done a total of 60 minutes physical activity was **`r filter(stats, breakdown == group_breakdown & question =='pa_60') %>% filter(count == max(count)) %>% .$response`** days. 
