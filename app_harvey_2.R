...
server <- function(input, output) {
  ...
  export_mod_server(id = "export",
                    ...
                    exp_year = reactive(input$exp_year),
                    exp_breakdown = reactive(input$exp_breakdown),
                    exp_theme = reactive(input$exp_theme),
                    exp_question = reactive(input$exp_question),
                    export_button = reactive(input$export_button))
