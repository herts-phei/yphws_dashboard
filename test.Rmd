---
title: "<center>![](https://hcc-phei.shinyapps.io/yphws_dashboard/_w_d9a8bf48/img/yphws_logo_horizontal.png){style=width:50%;} <br> Young People's Health and Wellbeing Survey</center>"
...
board <- board_rsconnect(server = "https://hertscc.managed.mango-solutions.com/connect",
                         key = Sys.getenv("CONNECT_API_KEY"))
...
if(group == "caring"){
data <- data %>%
  mutate(caring = case_when(caring == "Yes" ~ "Young carer",
                            caring == "No" ~ "Non-carer",
...
if(group == "bullied"){
  data <- data %>%
  mutate(bullied = case_when(bullied == "Yes" ~ "Bullied",
...
if(group == "selfharm_ever"){
  data <- data %>%
  mutate(selfharm_ever = case_when(selfharm_ever == "Yes" ~ "Self-harmed",
